...
{
    /// <summary>
    /// Current state of the shipment: Created, Scheduled, Dispatched, Delivered, Cancelled, Returned
    /// </summary>
    ...
    public List<ShipmentLineEventDto> Lines { get; init; } = new();
...
/// <summary>
/// DTO for shipment line in events
/// </summary>
public class ShipmentLineEventDto
{
